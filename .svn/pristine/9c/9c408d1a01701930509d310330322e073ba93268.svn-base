...
/**
 * <p>GetPhoneOrderReqModel complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetPhoneOrderReqModel">
 *   &lt;complexContent>
...
@XmlType(name = "GetPhoneOrderReqModel", propOrder = {
    "orderNo",
    "userid"
})
public class GetPhoneOrderReqModel {
