...
public class XssShieldUtil {
    ...
    private static List<Object[]> getXssPatternList() {
            ...
            ret.add(new Object[]{"\"", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL});
            ret.add(new Object[]{"domxssExecutionSink*", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL});
            ret.add(new Object[]{"javascript:domxssExecutionSink*", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL});
            ret.add(new Object[]{"<(no)?script[^>]*>.*?</(no)?script>", Pattern.CASE_INSENSITIVE});
            ret.add(new Object[]{"java:domxssExecutionSink*", Pattern.CASE_INSENSITIVE});
    ...
    public static void main(String[] args) {
        ...
        value = XssShieldUtil.stripXss("javascript:domxssExecutionSink(1,\"'\\\"&gt;()locxss\")");
        System.out.println("type-0: '" + value + "'");
        ...
        value = XssShieldUtil.stripXss("%25e5%25b8%2582%25e5%259c%25ba%25e6%258e%25a8%25e5%25b9%25bf\"onmouseover=OtcR(9772)\"");
        System.out.println("type-14: " + value + "");

        value = XssShieldUtil.stripXss("java:domxssExecutionSink(1,\"'\\\"&gt;()locxss\")");
