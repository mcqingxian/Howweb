...
public interface SessionConstants {
	...
	public interface SESSION_VERCODE_KEYS {
		...
		// 手机找回密码,手机
		public static String RETRIEVE_PHONE = "RETRIEVE_PHONE";
		// 邮箱找回密码,验证码
		...
		// 用户登录的时候，需要先填写验证码，防止用户恶意匹配密码
		public static String LOGIN_VERCODE = "LOGIN_VERCODE";
	}
	...
	public interface SESSION_REGIST_VERCODE_KEYS {
		...
		// 手机号
		public static String PHONE_REGIST_PHONE = "PHONE_REGIST_PHONE";
	}
