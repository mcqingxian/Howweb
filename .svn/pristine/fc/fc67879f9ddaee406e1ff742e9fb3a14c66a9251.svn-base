package com.hoau.how.module.util.mail.impl;
...
public class MailHelper implements IMailHelper {
	public static final String FROM_USER = "omsadmin@hoau.net";
	...
	public static void main(String[] args) {
		...
		try {
			...
			messageHelper.setFrom("omsadmin@hoau.net");
			messageHelper.setTo("tao.mo@itiaoling.com");
