...
public class CreateImageCodeUtil {
    ...
    private void creatImage() {
        ...
        String str1 = Utils.randomStr(codeCount);// 得到随机字符
        this.code = str1;
    ...
    public void write(OutputStream sos,String formatName) throws IOException {
        ImageIO.write(buffImg, formatName, sos);
        sos.close();
    }
 ...
 /*public void getCode3(HttpServletRequest req, HttpServletResponse response,HttpSession session) throws IOException{
        // 设置响应的类型格式为图片格式
            ...
            vCode.write(response.getOutputStream(),"jpeg");
     }*/
