...
import com.hoau.wechat.util.CreateImageCodeUtil;
...
public class CheckValidateCodeAction extends AbstractAction {
	...
	public String execute() throws IOException {
		...
		if(codeName == null || codeName.equals("")){
			...
			if(codeName.equals(SessionConstants.SESSION_VERCODE_KEYS.LOGIN_VERCODE)){
				ctx.getSession().put(SessionConstants.SESSION_VERCODE_KEYS.LOGIN_VERCODE, vCode.getCode());
			}else if(codeName.equals(SessionConstants.SESSION_VERCODE_KEYS.PHONE_VERCODE)){
