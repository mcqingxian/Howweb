...
<body onload="createMap('<s:property value="departmentEntity.lng"/>','<s:property value="departmentEntity.lat"/>','<s:property value="departmentEntity.deptName"/>','<s:property value="departmentEntity.phone"/>','<s:property value="departmentEntity.addressDetail"/>','<s:property value="departmentEntity.serviceName"/>');">
...
<div class="content">
	<div class="p_w">
		...
		<div class="map_main">
			...
			<div class="resultTit">
				<a href="companyScreenAction!queryAll.action">全部</a>  &nbsp;&gt;&nbsp; <a href="javascript:history.back();">公司列表</a>  &nbsp;&gt;&nbsp; <s:property value="departmentEntity.deptName"/>
			</div>
			<div class="resultDe">	
