...
/**
 * <p>ModifyOrderResModel complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ModifyOrderResModel">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="phoneOrderReqModel" type="{http://model.mobile.interfaces.sinotrans.com}PhoneOrderReqModel" minOccurs="0"/>
...
@XmlType(name = "ModifyOrderResModel", propOrder = {
    "phoneOrderReqModel",
    "result",
    "resultCode",
    "resultInfo",
...
public class ModifyOrderResModel {

    @XmlElementRef(name = "phoneOrderReqModel", namespace = "http://model.mobile.interfaces.sinotrans.com", type = JAXBElement.class)
    protected JAXBElement<PhoneOrderReqModel> phoneOrderReqModel;
     ...
     *     
     */
    public JAXBElement<PhoneOrderReqModel> getPhoneOrderReqModel() {
        return phoneOrderReqModel;
    }

    /**
     * 设置phoneOrderReqModel属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link PhoneOrderReqModel }{@code >}
     *     
     */
    public void setPhoneOrderReqModel(JAXBElement<PhoneOrderReqModel> value) {
        this.phoneOrderReqModel = value;
    }
