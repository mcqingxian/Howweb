 ...
 * generated in the com.hoau.mhow.invokews.server.ws.goodstrace package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hoau.mhow.invokews.server.ws.goodstrace
     * 
     */
