 ...
 *       &lt;sequence>
 *         &lt;element name="queryOrderModel" type="{http://model.mobile.interfaces.sinotrans.com}ArrayOfQueryOrderModel" minOccurs="0"/>
...
public class QueryOrdersResModel {
    ...
    @XmlElementRef(name = "queryOrderModel", namespace = "http://model.mobile.interfaces.sinotrans.com", type = JAXBElement.class)
    protected JAXBElement<ArrayOfQueryOrderModel> queryOrderModel;
    ...
    /**
     * 获取queryOrderModel属性的值。
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfQueryOrderModel }{@code >}
     *     
     */
    public JAXBElement<ArrayOfQueryOrderModel> getQueryOrderModel() {
        return queryOrderModel;
    }

    /**
     * 设置queryOrderModel属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfQueryOrderModel }{@code >}
     *     
     */
    public void setQueryOrderModel(JAXBElement<ArrayOfQueryOrderModel> value) {
        this.queryOrderModel = value;
    }
