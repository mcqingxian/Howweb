...
/**
 * <p>TrackOrderResModel complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="TrackOrderResModel">
 *   &lt;complexContent>
 ...
 *         &lt;element name="trackList" type="{http://model.customer.interfaces.sinotrans.com}ArrayOfTrackInfoModel" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TrackOrderResModel", propOrder = {
    "customerCode",
    "result",
    "resultCode",
    "resultInfo",
...
public class TrackOrderResModel {
    ...
    @XmlElementRef(name = "trackList", namespace = "http://model.customer.interfaces.sinotrans.com", type = JAXBElement.class)
    protected JAXBElement<ArrayOfTrackInfoModel> trackList;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfTrackInfoModel }{@code >}
     *     
     */
    public JAXBElement<ArrayOfTrackInfoModel> getTrackList() {
        return trackList;
    }
     ...
     *     
     */
    public void setTrackList(JAXBElement<ArrayOfTrackInfoModel> value) {
