...
/**
 * <p>QueryOrderReqModel complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="QueryOrderReqModel">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="customerCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="guidList" type="{http://services.customer.interfaces.sinotrans.com}ArrayOfString" minOccurs="0"/>
...
@XmlType(name = "QueryOrderReqModel", propOrder = {
    "customerCode",
    "guidList",
    "orign"
})
public class QueryOrderReqModel {
    ...
    @XmlElementRef(name = "guidList", namespace = "http://model.customer.interfaces.sinotrans.com", type = JAXBElement.class)
    protected JAXBElement<ArrayOfString> guidList;
     ...
     *     
     */
    public JAXBElement<ArrayOfString> getGuidList() {
        return guidList;
    }
     ...
     *     
     */
    public void setGuidList(JAXBElement<ArrayOfString> value) {
        this.guidList = value;
    }
