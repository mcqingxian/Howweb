...
public class DepartmentEntity extends BaseEntity{
	 ...
	 * 送货依托物流代码
	 */
	private String deliveryDependLogistCode;
	
	/**
	 * 自提依托物流代码
	 */
	private String takeSelfDependLogistCode;
	 ...
	 * 特许门店名称
	 */
	private String franchiseCompanyName;

	/**
	 * @author 唐征征
	 * @date 2017/7/26 下午2:12
	 * @description
	 */
	/**
	 * 地图中服务范围颜色
	...
	public String getDeliveryDependLogistCode() {
		return deliveryDependLogistCode;
	}

	public void setDeliveryDependLogistCode(String deliveryDependLogistCode) {
		this.deliveryDependLogistCode = deliveryDependLogistCode;
	}

	public String getTakeSelfDependLogistCode() {
		return takeSelfDependLogistCode;
	}

	public void setTakeSelfDependLogistCode(String takeSelfDependLogistCode) {
		this.takeSelfDependLogistCode = takeSelfDependLogistCode;
	}
