...
import com.hoau.mhow.module.bse.api.server.service.IPriceTTQService;
import com.hoau.mhow.module.bse.api.shared.vo.PriceTimeVo;
import com.hoau.wechat.constant.PropertyConstant;
import com.hoau.wechat.util.HttpUtil;
...
public class PriceTTQService implements IPriceTTQService {
	...
	public List<PriceQueryResult> getTTQPrice(PriceQueryVo priceVo) {
		String url = PropertyConstant.TTQ_PRICE_URL + "&";
