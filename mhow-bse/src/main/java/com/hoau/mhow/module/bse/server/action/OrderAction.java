...
public class OrderAction extends AbstractAction{
	...
	private List<PriceQueryResult> priceList;
	...
	public String quickOrder(){
		try {
			entity = orderService.queryOneOrder(orderId);
			this.fromPage = "quick";
		} catch (Exception e) {
			e.printStackTrace();
			return "index";
	...
	private void checkQuickEiNetOrder(){
		this.errorType = "systemError";
		if(StringUtil.isEmpty(entity.getEinoShipperEbsaContact()) || 
				"".equals(entity.getEinoShipperEbsaContact())){  //发货人为null 或 “”时
			setThisErrorMsg("发货人不能为空！");
		} else if((StringUtil.isEmpty(entity.getEinoShipperEbsaMobile()) || 
				"".equals(entity.getEinoShipperEbsaMobile())) && 
				(StringUtil.isEmpty(entity.getEinoShipperEbsaTel()) || 
						"".equals(entity.getEinoShipperEbsaTel()))){ //收货人手机为null 或 “”时
			setThisErrorMsg("发货人手机和座机不能同时为空！");
		}else if(StringUtil.isEmpty(entity.getShipperDistrict()) || 
				"".equals(entity.getShipperDistrict())){
			setThisErrorMsg("发货人省市区不能为空！");
		} else if(StringUtil.isEmpty(entity.getEinoShipperEbsaAddress()) || 
	...
	public List<PriceQueryResult> getPriceList() {
		return priceList;
	}
