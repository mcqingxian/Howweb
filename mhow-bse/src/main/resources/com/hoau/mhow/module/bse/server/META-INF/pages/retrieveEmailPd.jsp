...
<script src="<%=request.getContextPath()%>/scripts/bse/retrieveEmailPd.js"></script>
<script>
				...
				<div data-role="content">
					<div class="grid-main">
						<div class="form-reg">
							<ul class="fm-list">
								<li>
									<label><span class="f_yellow">*</span>邮箱地址</label>
									<input id="email" class="input-text-line" name="phoneNo" data-role="none"  placeholder="请输入绑定邮箱"/>
								...
								<li class="fm-checkcode">
									...
									<span>
										...
										src="<%=request.getContextPath()%>/bse/genCheckCode.action?codeName=EMAIL_VERCODE" width="30%" height="28"
										style="vertical-align: middle;" onclick="changeCode()" /> <a
										href="javascript:changeCode();">换一组</a>
									</span>
								</li>
								<li class="fm-checkcode">
									<label><span class="f_yellow">*</span>邮箱验证码</label>
									<input id="validateCode" class="input-text-line" type="tel" data-role="none" style="border:0px;width:100%" placeholder="请输入邮箱验证码">
									<span class="btn-r">
							...
							<p class="tc" style="padding:0.5em 0">
								<a href="<%=request.getContextPath()%>/bse/toRetrievePhonePd.action" class="f_yellow" style="border-bottom:1px solid #f0572c" data-ajax='false'>手机验证找回密码</a>
							</p>
						</div>
					</div>
				</div>
...
<!-- 弹出对话框 -->
<div data-role="dialog" id="retrieveEmail_dialog" data-close-btn="right">
	<div data-role="header">
		<h1 id="retrieveEmail_header"></h1>
	</div>
	<div data-role="content">
		<div align="center" id="retrieveEmail_dialog_con"><s:property value='errorMsg'/></div>
	</div>
</div>
</body>
</html>
